...
- `v1.2.5`, `v1.2`, `edge`, `stable`, `latest`
  [(v1.2/alpine/Dockerfile)][113]
- `v1.2.5-onbuild`, `v1.2-onbuild`, `edge-onbuild`, `stable-onbuild`, `onbuild`
  [(v1.2/alpine-onbuild/Dockerfile)][114]
- `v1.2.5-debian`, `v1.2-debian`, `edge-debian`, `stable-debian`, `debian`
  [(v1.2/debian/Dockerfile)][115]
- `v1.2.5-debian-onbuild`, `v1.2-debian-onbuild`, `edge-debian-onbuild`, `v1.1-debian-onbuild`, `stable-debian-onbuild`,
...
v1.2 is for fluentd v1.2.x releases. This is current stable version..
