...
- `v1.19.3-2.0`, `v1.19-2`, `edge`, `latest`
  [(v1.19/debian/Dockerfile)][fluentd-1-debian] (Since v1.19.0, alpine image will not be shipped anymore.)
- `v1.19.3-debian-2.0`, `v1.19-debian-2`, `edge-debian`
  (multiarch image for arm64(AArch64), armhf and amd64(x86_64))
- `v1.19.3-debian-amd64-2.0`, `v1.19-debian-amd64-2`, `edge-debian-amd64`
  [(v1.19/debian/Dockerfile)][fluentd-1-debian]
- `v1.19.3-debian-arm64-2.0`, `v1.19-debian-arm64-2`, `edge-debian-arm64`
