...
- `v1.19.2-2.1`, `v1.19-2`, `edge`, `latest`
  [(v1.19/debian/Dockerfile)][fluentd-1-debian] (Since v1.19.0, alpine image will not be shipped anymore.)
- `v1.19.2-debian-2.1`, `v1.19-debian-2`, `edge-debian`
  (multiarch image for arm64(AArch64), armhf and amd64(x86_64))
- `v1.19.2-debian-amd64-2.1`, `v1.19-debian-amd64-2`, `edge-debian-amd64`
  [(v1.19/debian/Dockerfile)][fluentd-1-debian]
- `v1.19.2-debian-arm64-2.1`, `v1.19-debian-arm64-2`, `edge-debian-arm64`
  [(v1.19/arm64/debian/Dockerfile)][fluentd-1-debian-arm64]
- `v1.19.2-debian-armhf-2.1`, `v1.19-debian-armhf-2`, `edge-debian-armhf`
