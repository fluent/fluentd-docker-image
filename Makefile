...
X86_IMAGES := \
	...
	v1.7/alpine:v1.7.0-1.0,v1.7-1,edge \
	v1.7/debian:v1.7.0-debian-1.0,v1.7-debian-1,edge-debian \
	v1.7/windows:v1.7.0-windows-1.0,v1.7-windows-1
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.7/armhf/debian:v1.7.0-debian-armhf-1.1,v1.7-debian-armhf-1,edge-debian-armhf \
