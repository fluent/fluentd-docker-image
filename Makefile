...
X86_IMAGES := \
	...
	v1.3/alpine:v1.3.0,v1.3,edge,stable,latest \
	v1.3/alpine-onbuild:v1.3.0-onbuild,v1.3-onbuild,edge-onbuild,stable-onbuild,onbuild \
	v1.3/debian:v1.3.0-debian,v1.3-debian,edge-debian,stable-debian,debian \
	v1.3/debian-onbuild:v1.3.0-debian-onbuild,v1.3-debian-onbuild,edge-debian-onbuild,stable-debian-onbuild,debian-onbuild \
	v1.3/windows:v1.3.0-windows,stable-windows,windows
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.3/armhf/debian:v1.3.0-debian-armhf,v1.3-debian-armhf,edge-debian-armhf,stable-debian-armhf,debian-armhf \
	v1.3/armhf/debian-onbuild:v1.3.0-debian-armhf-onbuild,v1.3-debian-armhf-onbuild,edge-debian-armhf-onbuild,stable-debian-armhf-onbuild,debian-armhf-onbuild
