...
X86_IMAGES := \
	...
	v1.5/alpine:v1.5.0-1.0,v1.5-1,edge \
	v1.5/alpine-onbuild:v1.5.0-onbuild-1.0,v1.5-onbuild-1,edge-onbuild \
	v1.5/debian:v1.5.0-debian-1.0,v1.5-debian-1,edge-debian \
	v1.5/debian-onbuild:v1.5.0-debian-onbuild-1.0,v1.5-debian-onbuild-1,edge-debian-onbuild \
	v1.5/windows:v1.5.0-windows-1.0,v1.5-windows-1
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.5/armhf/debian:v1.5.0-debian-armhf-1.0,v1.5-debian-armhf-1,edge-debian-armhf \
	v1.5/armhf/debian-onbuild:v1.5.0-debian-armhf-onbuild-1.0,v1.5-debian-armhf-onbuild-1,edge-debian-armhf-onbuild
