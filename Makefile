...
X86_IMAGES := \
	...
	v1.4/alpine:v1.4.1-1.0,v1.4-1,edge \
	v1.4/alpine-onbuild:v1.4.1-onbuild-1.0,v1.4-onbuild-1,edge-onbuild \
	v1.4/debian:v1.4.1-debian-1.0,v1.4-debian-1,edge-debian \
	v1.4/debian-onbuild:v1.4.1-debian-onbuild-1.0,v1.4-debian-onbuild-1,edge-debian-onbuild \
	v1.4/windows:v1.4.1-windows-1.0,v1.4-windows-1
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.4/armhf/debian:v1.4.1-debian-armhf-1.0,v1.4-debian-armhf-1,edge-debian-armhf \
	v1.4/armhf/debian-onbuild:v1.4.1-debian-armhf-onbuild-1.0,v1.4-debian-armhf-onbuild-1,edge-debian-armhf-onbuild
