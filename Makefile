...
X86_IMAGES := \
	v1.10/alpine:v1.10.1-1.0,v1.10-1,edge \
	v1.10/debian:v1.10.1-debian-1.0,v1.10-debian-1,edge-debian \
	v1.10/windows:v1.10.1-windows-1.0,v1.10-windows-1
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.10/armhf/debian:v1.10.1-debian-armhf-1.0,v1.10-debian-armhf-1,edge-debian-armhf \

# Define images for running on ARM64 platforms
ARM64_IMAGES := \
	v1.10/arm64/debian:v1.10.1-debian-arm64-1.0,v1.10-debian-arm64-1,edge-debian-arm64 \
