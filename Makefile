...
X86_IMAGES := \
	v1.19/debian:v1.19.2-debian-amd64-2.3,v1.19-debian-amd64-2,v1.19.2-debian-amd64,edge-debian-amd64
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.19/armhf/debian:v1.19.2-debian-armhf-2.3,v1.19-debian-armhf-2,v1.19.2-debian-armhf,edge-debian-armhf

# Define images for running on ARM64 platforms
ARM64_IMAGES := \
	v1.19/arm64/debian:v1.19.2-debian-arm64-2.3,v1.19-debian-arm64-2,v1.19.2-debian-arm64,edge-debian-arm64
WINDOWS_IMAGES := \
