...
X86_IMAGES := \
	...
	v1.6/alpine:v1.6.1-1.0,v1.6-1,edge \
	v1.6/debian:v1.6.1-debian-1.0,v1.6-debian-1,edge-debian \
	v1.6/windows:v1.6.1-windows-1.0,v1.6-windows-1
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.6/armhf/debian:v1.6.1-debian-armhf-1.0,v1.6-debian-armhf-1,edge-debian-armhf \
