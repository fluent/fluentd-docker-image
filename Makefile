...
X86_IMAGES := \
	...
	v1.4/alpine:v1.4.2-2.0,v1.4-2,edge \
	v1.4/alpine-onbuild:v1.4.2-onbuild-2.0,v1.4-onbuild-2,edge-onbuild \
	v1.4/debian:v1.4.2-debian-2.0,v1.4-debian-2,edge-debian \
	v1.4/debian-onbuild:v1.4.2-debian-onbuild-2.0,v1.4-debian-onbuild-2,edge-debian-onbuild \
	v1.4/windows:v1.4.2-windows-2.0,v1.4-windows-2
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.4/armhf/debian:v1.4.2-debian-armhf-2.0,v1.4-debian-armhf-2,edge-debian-armhf \
	v1.4/armhf/debian-onbuild:v1.4.2-debian-armhf-onbuild-2.0,v1.4-debian-armhf-onbuild-2,edge-debian-armhf-onbuild
