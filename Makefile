...
X86_IMAGES := \
	v1.19/debian:v1.19.3-debian-amd64-2.0,v1.19-debian-amd64-2,v1.19.3-debian-amd64,edge-debian-amd64
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.19/armhf/debian:v1.19.3-debian-armhf-2.0,v1.19-debian-armhf-2,v1.19.3-debian-armhf,edge-debian-armhf
