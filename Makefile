...
X86_IMAGES := \
	...
	v1.7/alpine:v1.7.3-1.0,v1.7-1,edge \
	v1.7/debian:v1.7.3-debian-1.0,v1.7-debian-1,edge-debian \
	v1.7/windows:v1.7.3-windows-1.0,v1.7-windows-1
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.7/armhf/debian:v1.7.3-debian-armhf-1.0,v1.7-debian-armhf-1,edge-debian-armhf \
