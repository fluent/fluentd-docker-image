...
ARM_IMAGES := \
	v1.14/armhf/debian:v1.14.5-debian-armhf-1.0,v1.14-debian-armhf-1,edge-debian-armhf \

# Define images for running on ARM64 platforms
ARM64_IMAGES := \
	v1.14/arm64/debian:v1.14.5-debian-arm64-1.0,v1.14-debian-arm64-1,edge-debian-arm64 \

WINDOWS_IMAGES := \
	v1.14/windows-ltsc2019:v1.14.5-windows-ltsc2019-1.0,v1.14-windows-ltsc2019-1 \
	v1.14/windows-20H2:v1.14.5-windows-20H2-1.0,v1.14-windows-20H2-1
