...
X86_IMAGES := \
	v1.15/alpine:v1.15.2-1.0,v1.15-1,edge \
	v1.15/debian:v1.15.2-debian-amd64-1.0,v1.15-debian-amd64-1,edge-debian-amd64
#	<Dockerfile>:<version>,<tag1>,<tag2>,...

# Define images for running on ARM platforms
ARM_IMAGES := \
	v1.15/armhf/debian:v1.15.2-debian-armhf-1.0,v1.15-debian-armhf-1,edge-debian-armhf \

# Define images for running on ARM64 platforms
ARM64_IMAGES := \
	v1.15/arm64/debian:v1.15.2-debian-arm64-1.0,v1.15-debian-arm64-1,edge-debian-arm64 \

WINDOWS_IMAGES := \
	v1.15/windows-ltsc2019:v1.15.2-windows-ltsc2019-1.0,v1.15-windows-ltsc2019-1 \
	v1.15/windows-20H2:v1.15.2-windows-20H2-1.0,v1.15-windows-20H2-1 \
	v1.15/windows-ltsc2022:v1.15.2-windows-ltsc2022-1.0,v1.15-windows-ltsc2022-1
